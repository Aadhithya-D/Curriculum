#!/usr/bin/env python3
"""Build the Urban Spoken Hindi HTML site and print document."""
...
COURSES_META = [
    {
        ...
        "title": "Children · Pehli baat",
        "blurb": "Namaste, aap/tum, family, tiffin, kirana, and class Hindi. Games first. Full sentences soon.",
        "hours": "24–72",
        "lessons": number_lessons(CHILDREN_BEGINNER),
        "who": "Urban children aged 6–10 who rarely speak Hindi, or who only answer in English or a home language.",
        "done": "The child can greet with aap, name family and school things, buy one item at a kirana, ask for help, and give a one-minute ‘Main kaun hoon’.",
        "place": "Place here if the child answers with one word, silence, or only English, and needs pictures and movement.",
        "note": "Keep lessons physical. Never force a child to perform before they have rehearsed with a partner. Do not shame English-medium kids for mixing; pull them into Hindi output.",
        "tests": [
            ("Start", "Namaste, name, point to three things and name them in Hindi."),
            ("Mid (after the first test lesson)", "Name, age, family, one polite request, favourite food."),
            ("End", "One-minute ‘Main kaun hoon’ plus kirana or help role-play."),
        ],
    },
    {
        ...
        "age_label": "Children 6–10",
        "level": "Elementary",
        "title": "Children · Sheher ki baat",
        "blurb": "School day, last Sunday, doctor, metro with a parent, and a two-minute city-life talk.",
        "hours": "24–72",
        "lessons": number_lessons(CHILDREN_ELEMENTARY),
        "who": "Children who can already say name, age, and a few likes in Hindi, and can follow a simple spoken class.",
        "done": "The child can tell a school day, a Sunday, give colony directions, visit a doctor or canteen in role-play, and speak for two minutes.",
        "place": "Place here if they already use short Hindi sentences and can do the Children’s Beginner final test.",
        "note": "Start past time (gaya / gayi, kiya / ki) and kyunki. Still use pictures. Still play. Teach gender only when it changes the day’s sentence.",
        "tests": [
    ...
    },
    {
        ...
        "level": "Beginner",
        "title": "Teens · School wali Hindi",
        "blurb": "Class, tiffin, phone, commute, and a two-minute ordinary day — without nursery talk.",
        "hours": "24–72",
        "lessons": number_lessons(TEENS_BEGINNER),
        "who": "Urban teens who hear Hindi at home or on the street but speak very little, or whose only Hindi is a textbook paragraph.",
        "done": "The teen can introduce themselves, talk school and weekend, make a phone plan, and repair a rude line (aap vs tum).",
        "place": "Place here if they freeze after one word, or if their Hindi is only written exam answers.",
        "note": "Respect their age. No animal songs. Use school, phone, and city. Ban ‘Main Ravi hoon’ as the whole identity.",
        "tests": [
    ...
    },
    {
        ...
        "title": "Teens · Samajhta hoon, bol nahi paata",
        "blurb": "The largest Indian teen group for Hindi. Opinions, stories, GD manners, photo talk, less freeze.",
        "hours": "24–72",
        "lessons": number_lessons(TEENS_INTERMEDIATE),
        "who": "Teens who follow Hindi films, class, and family talk — but go quiet when they must speak in full sentences.",
        "done": "They can speak for two minutes, join a kind GD, describe a photo, and disagree without a fight.",
        "place": "Place here if they can do the Teens Beginner test but still plan every word in English first.",
        "note": "Do not reteach hai/hain unless it blocks meaning. Push talking time. Correct after the turn, not during it.",
        "tests": [
    ...
    },
    {
        ...
        "title": "Teens · Lamba bolna, exam oral, manch",
        "blurb": "Extempore, Hindi oral long turns, rebuttal, and a crash path for school orals.",
        "hours": "20–72",
        "lessons": number_lessons(TEENS_UPPER),
        "who": "Teens who can already talk about school life and now need structure for Hindi orals, debates, and a short speech.",
        "done": "They can do a 3-minute long turn, a pair discussion, a short debate, and handle follow-up questions.",
        "place": "Place here after Intermediate, or if they already argue in Hindi but ramble or stay too English-mixed for an oral.",
        "note": "A 2–3 week crash uses only lessons tagged crash. Still rehearse standing. Teach when Hinglish is fine and when the examiner wants Hindi.",
        "tests": [
            ("Start", "2-minute opinion with an example and the other side."),
            ("Mid", "Oral-style long turn plus follow-up."),
    ...
    },
    {
        ...
        "level": "Beginner",
        "title": "Young adults · Campus se shuru",
        "blurb": "College, commute, money, hostel or PG, and a human talk about this year.",
        "hours": "24–72",
        "lessons": number_lessons(YA_BEGINNER),
        "who": "Urban young adults starting spoken Hindi seriously — campus, first job, or a year in a Hindi-using city.",
        "done": "They can move around campus in Hindi, split a bill, call a classmate, and give a two-minute year talk.",
        "place": "Place here if they still need full-sentence building on adult topics.",
        "note": "Keep the register adult. Money and stress belong here. No children’s games unless they ask.",
        "tests": [
    ...
    },
    {
        ...
        "age_label": "Young adults 18–25",
        "level": "Intermediate fluency",
        "title": "Young adults · Jo aata hai, use bolo",
        "blurb": "Kill the freeze. Proof stories, GDs, aunt-test explanations, meeting one-liners.",
        "hours": "24–72",
        "lessons": number_lessons(YA_FLUENCY),
        "who": "Young adults who understand Hindi films and family talk and still translate every sentence from English before they speak.",
        "done": "They can talk for three minutes, tell a proof story, join a GD, and explain their subject in plain Hindi.",
        "place": "The default course for ‘I understand Hindi but I can’t speak’ at this age.",
        "note": "No mid-sentence correction. Simpler Hindi is a win. Then send them to Interview if they have placements that need Hindi.",
        "tests": [
    ...
    },
    {
        ...
        "title": "Young adults · Interview aur pehli naukri",
        "blurb": "Apne baare mein, proof stories, why this role, GD, and mocks. Crash option included.",
        "hours": "20–48",
        "lessons": number_lessons(YA_INTERVIEW),
        "who": "Final-year students and first-job hunters who can already hold a conversation and now face Hindi or mixed-language interviews.",
        "done": "They can do a 12-minute mock with intro, proof, one story, and two questions for the panel.",
        "place": "Not for true beginners. Use after Fluency, or if they already speak at Intermediate.",
        "note": "Crash = lessons tagged crash, daily if possible. Never guarantee a job. Guarantee clearer speech. Formal aap stays on in the interview room.",
        "tests": [
    ...
    },
    {
        ...
        "title": "Adults · Zero se, izzat ke saath",
        "blurb": "Naam, dukaan, doctor, phone, building, school gate. Seniors use the same book, slower.",
        "hours": "24–72",
        "lessons": number_lessons(ADULTS_ABSOLUTE),
        "who": "Urban adults who have little or no spoken Hindi. Homemakers, workers, and seniors are all welcome.",
        "done": "They can greet, shop, ask for help, tell a simple day, and speak for one minute about their life.",
        "place": "Place here if they need English or another language for almost every instruction.",
        "note": SENIOR_NOTE,
        "tests": [
    ...
    },
    {
        ...
        "title": "Adults · Rozmarra sheher",
        "blurb": "PTA, doctor details, appointments, society, city travel, a week in the building.",
        "hours": "24–72",
        "lessons": number_lessons(ADULTS_EVERYDAY),
        "who": "Adults who can already do the Absolute Beginner test, or who survive a shop but freeze at school gate or the clinic.",
        "done": "They can handle PTA, a clinic story, a complaint, a neighbour chat, and a two-minute week talk.",
        "place": "Place here after Absolute, or if they can buy vegetables but cannot talk to a class teacher.",
    ...
    },
    {
        ...
        "title": "Adults · Meeting room ki Hindi",
        ...
        "who": "Working adults and return-to-work adults who understand office Hindi but stay quiet in rooms, or who only speak English at work and now need Hindi with teams or clients.",
        "done": "They can give a 30-second update, disagree politely, run a short meeting point, and brief a senior for four minutes.",
        "place": "Place here if they can do Everyday Hindi but go silent in meetings — or if they are returning to work.",
        "note": "Replace empty office padding with a clear ask. Homemakers returning to work use home operations as proof.",
        "tests": [
    ...
    },
    {
        ...
        "age_label": "Adults 26–50",
        "level": "Interview speaking",
        "title": "Adults · Interview, izzat ke saath",
        "blurb": "Career chapters, gaps, return-to-work, salary, mocks. Crash option included.",
        "hours": "20–48",
        "lessons": number_lessons(ADULTS_INTERVIEW),
        "who": "Adults changing jobs, returning after a break, or facing a Hindi/mixed panel after years of silent competence.",
        ...
        "note": "Delete shame phrases: ‘main toh ghar pe hi hoon’, ‘sirf gharwala kaam’. Never guarantee a job.",
        "tests": [
...
def search_index() -> list[dict]:
    items = [
        {"title": "Home", "group": "Guide", "href": "index.html", "hay": "curriculum urban spoken hindi courses"},
        {"title": "How to teach", "group": "Guide", "href": "teacher.html", "hay": "class formula error correction homework whatsapp aap tum"},
        {"title": "Place a student", "group": "Guide", "href": "placement.html", "hay": "placement test level age namaste"},
...
<head>
  ...
  <title>{esc(title)} · Urban Spoken Hindi</title>
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,560;9..144,640&family=Source+Sans+3:wght@400;600;700&family=Noto+Sans+Devanagari:wght@400;600;700&family=Noto+Serif+Devanagari:wght@500;600&display=swap" rel="stylesheet">
...
<body>
  ...
  <header class="app-header">
    <div class="header-left">
      ...
      <a class="brand" href="{prefix}index.html">
        <div class="mark">हि</div>
        <div class="brand-text">
          <strong>Urban Spoken Hindi</strong>
    ...
    <div class="header-actions">
      ...
      <a class="btn primary" href="{prefix}Spoken-Hindi-Curriculum.pdf">PDF</a>
    </div>
  ...
  <div class="layout">
    ...
    <main class="main" id="main">
      ...
      <p class="footer">Urban Spoken Hindi · For a teacher in an Indian city classroom · Open a lesson and teach today.</p>
    </main>
  </div>
...
def lesson_html(course_id: str, lesson: dict) -> str:
    ...
    <article class="lesson" id="{lesson["id"]}" data-timelines="{esc(lesson["timelines"])}">
      ...
      <div class="lesson-body">
        <p><strong>Aaj yeh bolo</strong></p>
...
def index_page() -> str:
    ...
    <section class="section">
      ...
      <div class="callout">This is not a Devanagari handwriting course and not a ‘shuddh Hindi’ course. The aim is clear, confident speech for real city life: school, home, metro, kirana, campus, office, and interviews. Everyday urban Hindi is welcome. Formal Hindi is taught when the room needs it.</div>
    </section>
    <section class="section">
...
def teacher_page() -> str:
    ...
    <article class="prose section">
      ...
      <h2>English and home language in the room</h2>
      <p>This is a spoken Hindi class, not a Hindi-only police station. At Beginner, you may give instructions in English or the home language. The <em>output</em> you want is still Hindi. From Intermediate up, stay in Hindi and keep a rescue line: <em>Dobara boliye, dheere.</em></p>
      <h2>Aap, tum, tu</h2>
      <p>This is social, not a grammar table. Default to <em>aap</em> with teachers, elders, shopkeepers you do not know, and any formal room. <em>Tum</em> is for friends and same-age classmates. <em>Tu</em> is intimate or rude if used wrongly — do not let beginners use it with a teacher. When a student says <em>aap ho</em>, repair to <em>aap hain</em>.</p>
      <h2>Gender in speech</h2>
      <p>Fix gender when it is the day’s target or when meaning flips (gaya / gayi, accha / acchi). Do not stop a free story for every ending. Boys and girls must hear both forms. Never mock a child who mixes them.</p>
      <h2>Hinglish</h2>
      <p>Urban Hindi mixes English. Do not shame <em>homework, tiffin, metro, meeting</em>. Teach when to stay in Hindi: principal, interview, exam oral, a formal complaint. Everyday kirana and colony talk can stay natural.</p>
      <h2>Group size</h2>
      ...
      <p>Devanagari handwriting as a goal, literature recitation as the core, ‘shuddh Hindi’ shaming of everyday speech, accent theatre, and long grammar lectures. Grammar only when it helps them speak. If a student later needs a board Hindi oral, use Upper Intermediate habits, then add the school’s oral format.</p>
    </article>
    """
...
def placement_page() -> str:
    ...
    <article class="prose section">
      ...
      <ol>
        <li>नमस्ते। आपका नाम क्या है? आप कैसे हैं? / तुम कैसे हो?</li>
        <li>घर में कौन-कौन है?</li>
        <li>आम दिन कैसा रहता है? (स्कूल / कॉलेज / काम / घर)</li>
        <li>पिछले इतवार को क्या किया?</li>
        <li>इस weekend क्या प्लान है?</li>
        <li>सड़क या क्लास की फोटो दिखाएँ। क्या दिख रहा है?</li>
        <li>राय: स्कूल / दफ्तर देर से शुरू होना चाहिए? क्यों?</li>
        <li>बड़े छात्रों के लिए: टीम में काम की कोई बात, या यह नौकरी क्यों?</li>
      </ol>
      ...
      <ul>
        <li>School Hindi orals, debates, manch → Teens Intermediate or Upper</li>
...
<head>
<meta charset="utf-8">
<title>Urban Spoken Hindi · Full curriculum</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+Devanagari:wght@400;600;700&family=Noto+Serif+Devanagari:wght@500;600&display=swap" rel="stylesheet">
<style>
  @page {{
    size: A4;
    margin: 16mm 14mm 18mm 14mm;
    @bottom-center {{
      content: "Urban Spoken Hindi  ·  " counter(page);
      font-family: "Noto Sans Devanagari", "Liberation Sans", sans-serif;
      font-size: 9pt;
      color: #4a453c;
    }}
  }}
  :root {{ --ink:#1c1914; --teal:#8b2e1f; --line:#d9d0be; --paper:#f7f1e4; }}
  body {{ margin:0; font-family: "Noto Serif Devanagari", "Liberation Serif", "Times New Roman", Georgia, serif; color:var(--ink); line-height:1.45; font-size: 11pt; }}
...
<section class="cover">
  ...
  <p>A teach-from-the-page curriculum for children, teens, young adults, and adults. Written so a teacher can open a lesson and start the same day.</p>
      <p>Twelve courses. Three timelines on every course. Crash paths for interviews and exam orals. Clear urban Hindi. No shuddh-Hindi shaming.</p>
  <p class="muted">Use the contents list to jump. In the PDF, those lines are links.</p>
</section>
<section class="page-break">
  <header class="run">Urban Spoken Hindi · Contents</header>
  <h2>Contents</h2>
  {''.join(toc)}
</section>
"""]
...
<section class="page-break" id="how">
  <header class="run">Urban Spoken Hindi · How to teach</header>
  <h2>How to teach</h2>
  ...
  <p>Correct the day’s target sentences during guided practice. Do not stop a story for small grammar. Never mock a student. Never treat adult beginners like children. English or home-language instructions are allowed at Beginner; the speech you want back is Hindi. Teach aap vs tum as a social choice. Fix gender only when it is the day’s target or it blocks meaning.</p>
...
<section class="page-break" id="place">
  <header class="run">Urban Spoken Hindi · Placement</header>
...
<section class="page-break" id="{c["id"]}">
  <header class="run">Urban Spoken Hindi · {esc(c["title"])}</header>
  <h2>{esc(c["title"])}</h2>
